...
object Example_seasonality_180412 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    var middleResult = spark.sql("select " +
      ...
      "a.regionid, a.product, b.product_name, a.yearweek, a.qty " +
      "from selloutTable a " +
    ...
    selloutDf.write.mode("overwrite").jdbc(outputUrl, table1, prop1)
    ...
    productMasterDf.write.mode("overwrite").jdbc(outputUrl, table2, prop2)
